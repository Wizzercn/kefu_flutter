...
class CachedImage extends StatelessWidget{
  CachedImage({@required this.src, this.width = 100.0, this.height = 100.0, this.fit = BoxFit.contain, this.bgColor, this.radius});
  final String src;
  final double width;
  final double height;
  final BoxFit fit;
  ...
  // 是否是本地资源
  bool get isLocal => src != null && !src.contains(RegExp(r'^(http://|https://)'));
  ...
  Widget build(BuildContext context) {
    ...
    try {
      ...
      return Container(
        ...
        child: Center(
          child: Text("图片已损坏\r\n或已删除", style: TextStyle(fontSize: 14.0, color: Colors.grey), textAlign: TextAlign.center,),
        ),
      );
    }
  }
