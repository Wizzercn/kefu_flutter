...
class ImMessage {
  ...
  ImMessage({this.bizType, this.uploadProgress, this.version, this.avatar,this.nickname, this.isShowCancel = false, this.payload, this.fromAccount, this.toAccount, this.timestamp, this.read, this.transferAccount});
